...
const SessionCard: React.FC<{ 
  ...
  return (
    <div
      ...
      onClick={onClick}
      className={cn(
        "rounded-md py-1 px-2 text-xs cursor-pointer",
        session.color,
...
type CompactWeeklyScheduleProps = {
  setIsProgramModalOpen : React.Dispatch<React.SetStateAction<boolean>>
}

export function CompactWeeklySchedule({setIsProgramModalOpen}: CompactWeeklyScheduleProps) {
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      <div className="space-y-2 relative">
        ...
        //       <p className="text-lg font-semibold mb-4">No training programs available</p>
